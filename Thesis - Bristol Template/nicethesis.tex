...
\documentclass[a4paper,11pt,reqno]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{datetime}
...
\chapter{Sensing with Heaviside Basis}
\label{chap:rect-basis}
\input{chapters/freq_model}

\chapter{Sensing with Heaviside Basis in time and frequency}
\label{chap:2d-rect-basis}
\input{chapters/time_freq_model}
