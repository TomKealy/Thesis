...
\title[Spectrum Sensing]{Group Testing and Spectrum Sensing} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Tom Kealy} % Your name
...
\medskip
\textit{tk12098@bristol.ac.uk} % Your email address
}
